            ...
            <div className="flex items-center gap-6 justify-end w-full">
                ...
                <div className="bg-background-primary rounded-full w-7 h-7 flex items-center justify-center cursor-pointer relative">
                    <Image 
                        ...
                        width={20}
                        height={20}/>
                    <div className="absolute -top-3 -right-3 w-5 h-5 flex items-center justify-center bg-purple-500 text-text-disabled rounded-full text-xs">1</div>
                </div>
                <div className="flex flex-col">
                    <span className="text-xs leading-3 font-medium">Username</span>
                    <span className="text-[10px] text-text-secondary text-right">Role</span>
                </div>
                <Image 
                        src="/avatar.png"
                        alt=""
